...
class PartNormalDataset(Dataset):
    def __init__(self, npoints=2500, split='train', normalize=False):
        ...
        self.root = './data/shapenet_rubber'
...
if __name__ == '__main__':
    train = PartNormalDataset(npoints=2048, split='trainval', normalize=True)
    test = PartNormalDataset(npoints=2048, split='test', normalize=True)
